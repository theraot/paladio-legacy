...
<@template lang="es" title="Paladio" stylesheets="main.css">
	...
	<@post id="intro" title="Demo" date="<?php echo time(); ?>" date-format="l, j \d\e F \d\e Y" author="Alfonos Ramos">
		<p>Esta es una demostración del Framework Paladio.</p>
	</@post>
	<div id="content">
		<div id="mainContent">
